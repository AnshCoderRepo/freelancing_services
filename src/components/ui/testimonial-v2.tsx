          ...
          <React.Fragment key={index}>
            {props.testimonials.map(({ text, image, name, role }, i) => (
              <motion.li
                ...
                className="p-10 rounded-3xl border border-neutral-800 shadow-lg shadow-black/5 max-w-xs w-full bg-neutral-900 transition-all duration-300 cursor-default select-none group focus:outline-none focus:ring-2 focus:ring-apple-blue/30"
              >
                <blockquote className="m-0 p-0">
                  <p className="text-neutral-400 leading-relaxed font-normal m-0 transition-colors duration-300">
                    {text}
                  </p>
                  <footer className="flex items-center gap-3 mt-6">
                    <img
                      ...
                      src={image}
                      alt={`Avatar of ${name}`}
                      className="h-10 w-10 rounded-full object-cover ring-2 ring-neutral-800 group-hover:ring-apple-blue/30 transition-all duration-300 ease-in-out"
                    />
